    ...
    <div className="py-20">
      <div className="container mx-auto">
        <div>
          <div>
            <div>
              <h1 className="lg:text-3xl text-gray-700 font-bold text-xl">
                Terms &amp; Conditions
              </h1>
              <p>Updated at 2023-02-07</p> <br />
              <h1 className="lg:text-3xl text-gray-700 font-bold text-xl">
                General Terms
              </h1>
              <p>
                <span className="text-xl">
                  By accessing and placing an order with , you confirm that you
                  ...
                  of communication between you and Under no circumstances shall
                  ...
                  <br />
                  <br /> will not be responsible for any outcome that may occur
              ...
              <p>
                <span className="text-xl">
                  ...
                  limited license to download, install and use our service
                  ...
                  not use the Service. In these Terms &amp; Conditions, "you"
              ...
              <p>
                <span className="text-xl">
                  ...
                  Service in accordance with the fees, charges and billing terms
                  in effect at the time that each fee or charge is due and
                  payable. Unless otherwise indicated in an order form, you must
                  provide us with a valid credit card (Visa, MasterCard, or any
                  other issuer accepted by us) (“Payment Provider”) as a
                  condition to signing up for the Premium plan. Your Payment
                  Provider agreement governs your use of the designated credit
                  card account, and you must refer to that agreement and not
                  these Terms to determine your rights and liabilities with
                  respect to your Payment Provider. By providing us with your
                  credit card number and associated payment information, you
                  agree that we are authorized to verify information
                  immediately, and subsequently invoice your account for all
                  fees and charges due and payable to us hereunder and that no
                  additional notice or consent is required. You agree to
                  immediately notify us of any change in your billing address or
                  the credit card used for payment hereunder. We reserve the
                  right at any time to change its prices and billing methods,
                  either immediately upon posting on our Site or by e-mail
                  delivery to your organization’s administrator(s). Any attorney
                  fees, court costs, or other costs incurred in collection of
                  delinquent undisputed amounts shall be the responsibility of
                  and paid for by you. No contract will exist between you and us
                  for the Service until we accept your order by a confirmatory
                  e-mail, SMS/MMS message, or other appropriate means of
                  communication. You are responsible for any third-party fees
              ...
              <p>
                <span className="text-xl">
                  ...
                  reproduced, downloaded or distributed in any way, in whole or
                  in part, without the express prior written permission of us,
              ...
              <p>
                <span className="text-xl">
                  ...
                  operate and control our Service from our offices in . The
